...
export const CogIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m15-3.75l-1.5-1.5m0 0l-1.5 1.5m1.5-1.5V3m0 18v-1.5m-15-15l1.5 1.5m0 0l1.5-1.5m-1.5 1.5V3m0 18v-1.5m15-15l-1.5 1.5m0 0l-1.5-1.5m1.5 1.5V3" />
    </svg>
);
...
export const SidebarRightIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const HomeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 10.5v8.25a1.5 1.5 0 001.5 1.5h15a1.5 1.5 0 001.5-1.5V10.5M8.25 21V12h7.5v9" />
    </svg>
);
...
export const TelegramIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M21.9,2.1C21.7,2,21.5,2,21.3,2.1l-19,7C2,9.3,1.9,9.7,2.1,10s0.5,0.4,0.8,0.4l5.9,1.7l1.7,5.9c0.1,0.3,0.4,0.5,0.7,0.5c0,0,0,0,0.1,0c0.3,0,0.6-0.2,0.7-0.5l7-19C18.9,2.6,18.8,2.2,18.5,2.1z M5.4,9.6l12-4.4L8,14.6L5.4,9.6z M14.4,18.6L9.4,6L15,11.6L14.4,18.6z"/>
    </svg>
);
...
export const SunIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.95-4.243l-1.59-1.59M3 12h2.25m.386-6.364l1.59 1.59M12 12a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5z" />
    </svg>
);
...
export const HashtagIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 3L8 21M16 3L14 21M4 9H20M4 15H20" />
    </svg>
);
...
export const WalletIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12a2.25 2.25 0 00-2.25-2.25H9.75A2.25 2.25 0 007.5 12v6a2.25 2.25 0 002.25 2.25h4.5a2.25 2.25 0 002.25-2.25v-6z" />
    </svg>
);
...
export const RefreshIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001a.75.75 0 01.05.022l3 3a.75.75 0 01-1.06 1.06l-2.755-2.755v-2.172c0-.213-.172-.385-.385-.385H16.023a.75.75 0 01-.75-.75c0-.414.336-.75.75-.75zm-4.934 9.043A.75.75 0 019.023 14.5v-2.172c0-.213-.172-.385-.385-.385H3.98v-.001a.75.75 0 01.05.022l-3 3a.75.75 0 01-1.06 1.06l2.755-2.755V14.5c0 .414.336.75.75.75h4.934a.75.75 0 01.75-.75z" />
    </svg>
);